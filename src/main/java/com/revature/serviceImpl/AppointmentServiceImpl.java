...
public class AppointmentServiceImpl implements AppointmentService {
	...
	@Override
	public AppointmentDto getAppointmentByIdAndStatus(int id,String Status,int index,int size) {
		return modelMapper.map(appointmentRepository.findByPatientIdAndAcceptanceOrderByDateDesc(id, Status,PageRequest.of(index, size)),AppointmentDto.class);
	}
	...
	public List<AppointmentDto> getAppointments(String acceptence ,String date,int index,int size){
		return (List<AppointmentDto>) appointmentRepository.findByAcceptanceAndDate(acceptence,date,PageRequest.of(index,size));	
	}
