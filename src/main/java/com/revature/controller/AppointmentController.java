...
public class AppointmentController {
	...
	public ResponseEntity<List<AppointmentDto>> getAcceptedAppointments(
		...
		if(details== null|| details.isEmpty()) {
			throw new ResourceNotFoundException("details not found with"+physicianEmail+" "+date+" "+acceptance+" ");
		}
		else
		{
...
//		return new ResponseEntity<>(appointmentService.getAllAppointments(patientId), HttpStatus.OK);
	...
	public ResponseEntity<AppointmentDto> getAppointment(@PathVariable(name = "id") int appointmentId) {
		...
		List<AppointmentDto> details= (List<AppointmentDto>) appointmentService.getAppointment(appointmentId);
		if(details== null|| details.isEmpty()) {
		...
		else
		{
			...
			return new ResponseEntity<>((AppointmentDto)details, HttpStatus.OK);
		}
